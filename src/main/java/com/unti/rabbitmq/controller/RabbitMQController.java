package com.unti.rabbitmq.controller;

import com.unti.rabbitmq.po.Mail;
import com.unti.rabbitmq.po.TopicMail;
import com.unti.rabbitmq.service.impl.ProducerImpl;
import com.unti.rabbitmq.service.impl.PublisherImpl;
...
public class RabbitMQController {
    ...
    @RequestMapping(value = "/produceReceive", produces = {"application/json;charset=UTF-8"})
    @ResponseBody
    public void produceReceive(@ModelAttribute("mail") Mail mail) throws Exception {
        producer.sendReceiveMail("receive", mail);
    }
